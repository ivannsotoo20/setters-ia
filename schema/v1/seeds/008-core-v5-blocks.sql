...
</protocolo_handoff>$FyzonCoreV5Block$, 0, 1, TRUE);

-- output_contract_v5 (2820 chars) — fuente: 02-output-contract.md
INSERT INTO public.prompt_blocks (tenant_id, channel_override, block_key, content, sort_order, version, is_active)
VALUES (NULL, NULL, 'output_contract_v5', $FyzonCoreV5Block$<output_contract>
...
</output_contract>$FyzonCoreV5Block$, 100, 1, TRUE);
