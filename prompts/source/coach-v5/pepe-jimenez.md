---
trainer: pepe-jimenez
tenant_slug: "[PENDIENTE — alta de tenant equipo-pj]"
block_key: coach_v5
sort_order: 5
version: 1
status: draft
approved: pending
cerebro: v5
sprint: pepe-hyrox-onboarding-2026-07-20
notes:
  - "Avatar NUEVO (HYROX / rendimiento híbrido, objetivo-first). Flujo B de la KB: proporción validación/dirección diseñada (~7/3 dirección desde F2, F1 conexión-first por público frío B7)."
  - "Voz del formulario de Pepe (Documentación Avatar). Literales notia/F5/F6 = DRAFT, pendientes de pase humano de Iván (§10/§12) + test de indistinguibilidad antes de seedear."
  - "F5 enmarcada PERSONAL (con Pepe), decisión de Iván 2026-07-20."
  - "CAPA trainer_prefs (NO va aquí, /settings/preferences): addressingMode=tú; aiMessagesPerTurnMax≈3-4 (manda varios mensajes); forbiddenPhrases=guapa,guapo,rey,reina,bebé; handoffMode."
  - "Follow-ups 12h/23h (M1-M3) van en followup_templates, NO en el coach."
  - "Alta de tenant equipo-pj pendiente: el seed hará RAISE EXCEPTION hasta que exista."
---
<coach_block>
