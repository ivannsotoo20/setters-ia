---
trainer: ivan-dev
tenant_slug: ivan-dev
block_key: coach_v5
sort_order: 5
version: 1
status: draft
approved: pending (Iván firma tras revisión)
cerebro: v5
sprint: Iota.2
notes:
  - Mapeado desde prompts/source/coach-v3/ivan-dev.md (estructura plana de 6 secciones) a la estructura canónica v5 (9 sub-secciones).
  - Tenant de pruebas "Ivan / Fyzon Sandbox" (tenant_id=3). Existe para validar el motor end-to-end con WhatsApp via YCloud antes de poner clientes reales.
---
