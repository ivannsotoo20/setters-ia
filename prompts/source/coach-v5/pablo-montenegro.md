---
trainer: pablo-montenegro
tenant_slug: montefit-pablo
block_key: coach_v5
sort_order: 5
version: 1
status: draft
...
sprint: Iota.2
notes:
  - Mapeado desde prompts/source/coach-v3/pablo-montenegro.md (estructura plana de 7 secciones) a la estructura canónica v5 (9 sub-secciones).
  - Contenido preservado fiel; solo se reorganiza por sub-sección. Iván revisa antes de seed.
---
