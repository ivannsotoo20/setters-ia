...
contains_subblocks:
  ...
  - resultado_esperado
sections_approved:
  identidad: 2026-05-07
  tareas: 2026-05-07
  proposito: 2026-05-07
  reglas: 2026-05-07
  objetivos: 2026-05-07
  resultado_esperado: 2026-05-07
recycled_from_legacy:
  identidad: <role> firmado 2026-05-07 (literal)
  tareas: <mental_model> + parte de <core_principles> firmados 2026-05-07
  proposito: <goal> CONECTAR/DETECTAR/GUIAR (parte 1)
  objetivos: <goal> 3 criterios universales (parte 2)
  resultado_esperado: <goal> resultados válidos + cierre cálido (parte 3)
  reglas: <message_types> + R3 te entiendo + nuevas R anti-derivación
---

<!--
  CEREBRO DEL SETTER (Core v4) — Bloque base.
  Arquitectura D43: 6 sub-bloques universales que valen para todo trainer.
  Conector XML al final (D52). Por ahora secciones markdown con nombres internos.
  Backup del archivo firmado anterior: ./_legacy/01-role-firmado-2026-05-07.md
-->
...
<!--
  Reciclado parcial de <goal> firmado 2026-05-07.
  Refactor pendiente: aquí solo va "Por qué existes" (función + valor del setter para el lead).
  Los 3 criterios universales bajan a sub-bloque 5 "Objetivos".
  Los resultados válidos bajan a sub-bloque 6 "Resultado esperado".
  Pendiente firma Iván tras refactor split.
-->
...
<!--
  Reciclado de <mental_model> + parte de <core_principles> firmados 2026-05-07.
  Aquí va el modelo mental de cómo opera el setter en cada turno.
-->
...
<!--
  Reciclado de <goal> firmado: los 3 criterios universales.
-->
...
<!--
  Reciclado de <goal> firmado + se conecta con <protocolo_handoff> universal.
-->
...
<!-- Fin del bloque CEREBRO DEL SETTER. Las 6 fases siguen en archivos separados. -->
