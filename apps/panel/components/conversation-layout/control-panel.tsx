...
export function ControlPanel({ detail }: Props) {
  if (!detail) {
    return (
      <aside
        className="hidden lg:flex flex-col gap-4 p-4 border-l border-border bg-card/30 overflow-y-auto items-center justify-center text-center text-sm text-muted-foreground"
  ...
  return (
    <aside
      className="flex flex-col gap-4 p-4 border-l border-border bg-card/30 overflow-y-auto"
      aria-label="Panel de control"
    >
